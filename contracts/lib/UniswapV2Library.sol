...
library UniswapV2Library {
  ...
  function calculatePair(address factory, address token0, address token1)
  ...
  function getCumulativePriceLast(address factory, address tokenIn, address tokenOut)
  internal view returns (uint256) {
    (address token0, address token1) = sortTokens(tokenIn, tokenOut);
    IUniswapV2Pair pair = IUniswapV2Pair(calculatePair(factory, token0, token1));
